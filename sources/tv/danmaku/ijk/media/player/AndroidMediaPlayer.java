...
public class AndroidMediaPlayer extends AbstractMediaPlayer {
    ...
    private class AndroidMediaPlayerListenerHolder implements OnBufferingUpdateListener, OnCompletionListener, OnErrorListener, OnInfoListener, OnPreparedListener, OnSeekCompleteListener, OnTimedTextListener, OnVideoSizeChangedListener {
        ...
        public boolean onInfo(MediaPlayer mediaPlayer, int i, int i2) {
            return (((AndroidMediaPlayer) this.mWeakMediaPlayer.get()) == null || AndroidMediaPlayer.this.notifyOnInfo(i, i2) == null) ? null : true;
        }

        public boolean onError(MediaPlayer mediaPlayer, int i, int i2) {
            return (((AndroidMediaPlayer) this.mWeakMediaPlayer.get()) == null || AndroidMediaPlayer.this.notifyOnError(i, i2) == null) ? null : true;
        }
        ...
        public void onTimedText(MediaPlayer mediaPlayer, TimedText timedText) {
            if (((AndroidMediaPlayer) this.mWeakMediaPlayer.get()) != null) {
                mediaPlayer = null;
                if (timedText != null) {
                    mediaPlayer = new IjkTimedText(timedText.getBounds(), timedText.getText());
                }
                AndroidMediaPlayer.this.notifyOnTimedText(mediaPlayer);
            }
        }
    }
