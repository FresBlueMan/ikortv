...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
    ...
    private static final IjkLibLoader sLocalLibLoader = new C12161();
        ...
        public void handleMessage(Message message) {
            ...
            if (ijkMediaPlayer != null) {
                ...
                if (ijkMediaPlayer.mNativeMediaPlayer != 0) {
                                ...
                                default:
                                    switch (i) {
                                        ...
                                        case 100:
                                            ...
                                            stringBuilder.append(")");
                                            DebugLog.m1464e(access$100, stringBuilder.toString());
                                            if (ijkMediaPlayer.notifyOnError(message.arg1, message.arg2) == null) {
                                                ijkMediaPlayer.notifyOnCompletion();
                                            }
                                            ijkMediaPlayer.stayAwake(false);
                                            return;
                                        default:
                                            ...
                                            DebugLog.m1464e(access$1002, stringBuilder2.toString());
                                            break;
                                    }
                            }
                        }
                    ...
                    if (message.arg1 == 3) {
                        DebugLog.m1466i(IjkMediaPlayer.TAG, "Info: MEDIA_INFO_VIDEO_RENDERING_START\n");
                    }
                    ijkMediaPlayer.notifyOnInfo(message.arg1, message.arg2);
                    return;
                }
            }
            DebugLog.m1470w(IjkMediaPlayer.TAG, "IjkMediaPlayer went away with unhandled events");
        }
    }
    ...
    static class C12161 implements IjkLibLoader {
        C12161() {
        }
    ...
    private void initPlayer(IjkLibLoader ijkLibLoader) {
        ...
        initNativeOnce();
        ijkLibLoader = Looper.myLooper();
        if (ijkLibLoader != null) {
            this.mEventHandler = new EventHandler(this, ijkLibLoader);
        } else {
            ijkLibLoader = Looper.getMainLooper();
            if (ijkLibLoader != null) {
                this.mEventHandler = new EventHandler(this, ijkLibLoader);
            } else {
    ...
    public void setSurface(Surface surface) {
        if (this.mScreenOnWhilePlaying && surface != null) {
            DebugLog.m1470w(TAG, "setScreenOnWhilePlaying(true) is ineffective for Surface");
        }
...
*/
    ...
    L_0x003b:
        ...
        r1 = "r";	 Catch:{ SecurityException -> 0x0084, IOException -> 0x0080, all -> 0x0078 }
    ...
    L_0x004e:
        ...
        r2 = 0;	 Catch:{ SecurityException -> 0x0085, IOException -> 0x0081, all -> 0x0076 }
        r4 = (r0 > r2 ? 1 : (r0 == r2 ? 0 : -1));	 Catch:{ SecurityException -> 0x0085, IOException -> 0x0081, all -> 0x0076 }
        if (r4 >= 0) goto L_0x0060;	 Catch:{ SecurityException -> 0x0085, IOException -> 0x0081, all -> 0x0076 }
    L_0x0058:
        ...
        goto L_0x0070;	 Catch:{ SecurityException -> 0x0085, IOException -> 0x0081, all -> 0x0076 }
    L_0x0060:
        ...
        r0 = r6;	 Catch:{ SecurityException -> 0x0085, IOException -> 0x0081, all -> 0x0076 }
    ...
    public void setDataSource(FileDescriptor fileDescriptor) {
        if (VERSION.SDK_INT < 12) {
            try {
                ...
                throw new RuntimeException(fileDescriptor2);
            } catch (FileDescriptor fileDescriptor22) {
                throw new RuntimeException(fileDescriptor22);
            }
        }
        fileDescriptor22 = ParcelFileDescriptor.dup(fileDescriptor22);
        try {
            _setDataSourceFd(fileDescriptor22.getFd());
        } finally {
            fileDescriptor22.close();
        }
    }
    ...
    public void setScreenOnWhilePlaying(boolean z) {
        if (this.mScreenOnWhilePlaying != z) {
            if (z && this.mSurfaceHolder == null) {
                DebugLog.m1470w(TAG, "setScreenOnWhilePlaying(true) is ineffective without a SurfaceHolder");
            }
    ...
    public float getSpeed(float f) {
        return _getPropertyFloat(1.4017E-41f, 0.0f);
    }
    ...
    private static boolean onNativeInvoke(Object obj, int i, Bundle bundle) {
        ...
        if (ijkMediaPlayer != null) {
            ...
            obj = ijkMediaPlayer.mOnControlMessageListener;
            if (obj == null) {
                return false;
            }
            i = bundle.getInt(OnNativeInvokeListener.ARG_SEGMENT_INDEX, -1);
            if (i >= 0) {
                obj = obj.onControlResolveSegmentUrl(i);
                if (obj != null) {
                    bundle.putString(OnNativeInvokeListener.ARG_URL, obj);
                    return true;
                }
