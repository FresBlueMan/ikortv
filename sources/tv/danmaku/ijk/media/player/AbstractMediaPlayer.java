...
public abstract class AbstractMediaPlayer implements IMediaPlayer {
    ...
    protected final boolean notifyOnError(int i, int i2) {
        return (this.mOnErrorListener == null || this.mOnErrorListener.onError(this, i, i2) == 0) ? false : true;
    }

    protected final boolean notifyOnInfo(int i, int i2) {
        return (this.mOnInfoListener == null || this.mOnInfoListener.onInfo(this, i, i2) == 0) ? false : true;
    }
