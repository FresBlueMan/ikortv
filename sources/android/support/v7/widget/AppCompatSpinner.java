...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    private class DropdownPopup extends ListPopupWindow {
        ...
        class C03832 implements OnGlobalLayoutListener {
            C03832() {
            }
        ...
        public void show() {
            ...
            if (!isShowing) {
                ...
                if (viewTreeObserver != null) {
                    final OnGlobalLayoutListener c03832 = new C03832();
                    viewTreeObserver.addOnGlobalLayoutListener(c03832);
                    setOnDismissListener(new OnDismissListener() {
                        public void onDismiss() {
                            ViewTreeObserver viewTreeObserver = AppCompatSpinner.this.getViewTreeObserver();
                            if (viewTreeObserver != null) {
                                viewTreeObserver.removeGlobalOnLayoutListener(c03832);
                            }
                        }
                    });
                }
    ...
    public AppCompatSpinner(Context context, int i) {
        this(context, null, C0360R.attr.spinnerStyle, i);
    }

    public AppCompatSpinner(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0360R.attr.spinnerStyle);
    }
    ...
    public AppCompatSpinner(android.content.Context r8, android.util.AttributeSet r9, int r10, int r11, android.content.res.Resources.Theme r12) {
        ...
        r0.<init>();
        r7.mTempRect = r0;
        r0 = android.support.v7.appcompat.C0360R.styleable.Spinner;
        r1 = 0;
    ...
    L_0x001b:
        ...
        goto L_0x003e;
    L_0x0023:
        r12 = android.support.v7.appcompat.C0360R.styleable.Spinner_popupTheme;
    ...
    L_0x004c:
        r12 = ATTRS_ANDROID_SPINNERMODE;	 Catch:{ Exception -> 0x0068, all -> 0x0065 }
        r12 = r8.obtainStyledAttributes(r9, r12, r10, r1);	 Catch:{ Exception -> 0x0068, all -> 0x0065 }
        r4 = r12.hasValue(r1);	 Catch:{ Exception -> 0x0063 }
        if (r4 == 0) goto L_0x005d;
    L_0x0058:
        r4 = r12.getInt(r1, r1);	 Catch:{ Exception -> 0x0063 }
        r11 = r4;
    L_0x005d:
    ...
    L_0x006a:
        ...
        android.util.Log.i(r5, r6, r4);	 Catch:{ all -> 0x0074 }
        if (r12 == 0) goto L_0x007c;
    L_0x0073:
        goto L_0x005f;
    L_0x0074:
    ...
    L_0x007e:
        ...
        r11.<init>(r12, r9, r10);
        r12 = r7.mPopupContext;
        r4 = android.support.v7.appcompat.C0360R.styleable.Spinner;
        r12 = android.support.v7.widget.TintTypedArray.obtainStyledAttributes(r12, r9, r4, r10, r1);
        r1 = android.support.v7.appcompat.C0360R.styleable.Spinner_android_dropDownWidth;
        r4 = -2;
        r1 = r12.getLayoutDimension(r1, r4);
        r7.mDropDownWidth = r1;
        r1 = android.support.v7.appcompat.C0360R.styleable.Spinner_android_popupBackground;
        r1 = r12.getDrawable(r1);
        r11.setBackgroundDrawable(r1);
        r1 = android.support.v7.appcompat.C0360R.styleable.Spinner_android_prompt;
        r1 = r0.getString(r1);
    ...
    L_0x00b4:
        r11 = android.support.v7.appcompat.C0360R.styleable.Spinner_android_entries;
    ...
    L_0x00bc:
        ...
        r12.<init>(r8, r1, r11);
        r8 = android.support.v7.appcompat.C0360R.layout.support_simple_spinner_dropdown_item;
