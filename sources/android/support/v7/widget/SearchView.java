...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C04063 implements OnFocusChangeListener {
        C04063() {
        }
    ...
    class C04074 implements OnLayoutChangeListener {
        C04074() {
        }
    ...
    class C04085 implements OnClickListener {
        C04085() {
        }
    ...
    class C04096 implements OnKeyListener {
        C04096() {
        }
    ...
    class C04107 implements OnEditorActionListener {
        C04107() {
        }
    ...
    class C04118 implements OnItemClickListener {
        C04118() {
        }
    ...
    class C04129 implements OnItemSelectedListener {
...
*/
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C04131();
        boolean isIconified;

        /* renamed from: android.support.v7.widget.SearchView$SavedState$1 */
        static class C04131 implements ClassLoaderCreator<SavedState> {
            C04131() {
            }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attributeSet) {
            this(context, attributeSet, C0360R.attr.autoCompleteTextViewStyle);
        }

        public SearchAutoComplete(Context context, AttributeSet attributeSet, int i) {
            super(context, attributeSet, i);
            this.mRunShowSoftInputIfNecessary = new C04141();
    ...
    public SearchView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0360R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mUpdateDrawableStateRunnable = new C04041();
        this.mReleaseCursorRunnable = new C04052();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C04085();
        this.mTextKeyListener = new C04096();
        this.mOnEditorActionListener = new C04107();
        this.mOnItemClickListener = new C04118();
        this.mOnItemSelectedListener = new C04129();
        ...
        attributeSet = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0360R.styleable.SearchView, i, 0);
        LayoutInflater.from(context).inflate(attributeSet.getResourceId(C0360R.styleable.SearchView_layout, C0360R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0360R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0360R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0360R.id.search_plate);
        this.mSubmitArea = findViewById(C0360R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0360R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0360R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0360R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0360R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0360R.id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, attributeSet.getDrawable(C0360R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, attributeSet.getDrawable(C0360R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(attributeSet.getDrawable(C0360R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(attributeSet.getDrawable(C0360R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(attributeSet.getDrawable(C0360R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(attributeSet.getDrawable(C0360R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(attributeSet.getDrawable(C0360R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = attributeSet.getDrawable(C0360R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(C0360R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = attributeSet.getResourceId(C0360R.styleable.SearchView_suggestionRowLayout, C0360R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = attributeSet.getResourceId(C0360R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C04063());
        setIconifiedByDefault(attributeSet.getBoolean(C0360R.styleable.SearchView_iconifiedByDefault, true));
        context = attributeSet.getDimensionPixelSize(C0360R.styleable.SearchView_android_maxWidth, -1);
        if (context != -1) {
            setMaxWidth(context);
        }
        this.mDefaultQueryHint = attributeSet.getText(C0360R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = attributeSet.getText(C0360R.styleable.SearchView_queryHint);
        context = attributeSet.getInt(C0360R.styleable.SearchView_android_imeOptions, -1);
        if (context != -1) {
            setImeOptions(context);
        }
        context = attributeSet.getInt(C0360R.styleable.SearchView_android_inputType, -1);
        if (context != -1) {
            setInputType(context);
        }
        setFocusable(attributeSet.getBoolean(C0360R.styleable.SearchView_android_focusable, true));
        ...
        if (this.mDropDownAnchor != null) {
            this.mDropDownAnchor.addOnLayoutChangeListener(new C04074());
        }
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0360R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0360R.dimen.abc_search_view_preferred_height);
    }
...
*/
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int dimensionPixelSize = this.mIconifiedByDefault ? resources.getDimensionPixelSize(C0360R.dimen.abc_dropdownitem_icon_width) + resources.getDimensionPixelSize(C0360R.dimen.abc_dropdownitem_text_padding_left) : 0;
