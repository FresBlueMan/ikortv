...
public class Toolbar extends ViewGroup {
    ...
    class C04192 implements Runnable {
        C04192() {
        }
    ...
    class C09821 implements android.support.v7.widget.ActionMenuView.OnMenuItemClickListener {
        C09821() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C04211();
        int expandedMenuItemId;
        boolean isOverflowOpen;

        /* renamed from: android.support.v7.widget.Toolbar$SavedState$1 */
        static class C04211 implements ClassLoaderCreator<SavedState> {
            C04211() {
            }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C0360R.attr.toolbarStyle);
    }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mMenuViewItemClickListener = new C09821();
        this.mShowOverflowMenuRunnable = new C04192();
        context = TintTypedArray.obtainStyledAttributes(getContext(), attributeSet, C0360R.styleable.Toolbar, i, 0);
        this.mTitleTextAppearance = context.getResourceId(C0360R.styleable.Toolbar_titleTextAppearance, 0);
        this.mSubtitleTextAppearance = context.getResourceId(C0360R.styleable.Toolbar_subtitleTextAppearance, 0);
        this.mGravity = context.getInteger(C0360R.styleable.Toolbar_android_gravity, this.mGravity);
        this.mButtonGravity = context.getInteger(C0360R.styleable.Toolbar_buttonGravity, 48);
        attributeSet = context.getDimensionPixelOffset(C0360R.styleable.Toolbar_titleMargin, 0);
        if (context.hasValue(C0360R.styleable.Toolbar_titleMargins) != 0) {
            attributeSet = context.getDimensionPixelOffset(C0360R.styleable.Toolbar_titleMargins, attributeSet);
        }
        ...
        attributeSet = context.getDimensionPixelOffset(C0360R.styleable.Toolbar_titleMarginStart, -1);
        if (attributeSet >= null) {
            this.mTitleMarginStart = attributeSet;
        }
        attributeSet = context.getDimensionPixelOffset(C0360R.styleable.Toolbar_titleMarginEnd, -1);
        if (attributeSet >= null) {
            this.mTitleMarginEnd = attributeSet;
        }
        attributeSet = context.getDimensionPixelOffset(C0360R.styleable.Toolbar_titleMarginTop, -1);
        if (attributeSet >= null) {
            this.mTitleMarginTop = attributeSet;
        }
        attributeSet = context.getDimensionPixelOffset(C0360R.styleable.Toolbar_titleMarginBottom, -1);
        if (attributeSet >= null) {
            this.mTitleMarginBottom = attributeSet;
        }
        this.mMaxButtonHeight = context.getDimensionPixelSize(C0360R.styleable.Toolbar_maxButtonHeight, -1);
        attributeSet = context.getDimensionPixelOffset(C0360R.styleable.Toolbar_contentInsetStart, Integer.MIN_VALUE);
        int dimensionPixelOffset = context.getDimensionPixelOffset(C0360R.styleable.Toolbar_contentInsetEnd, Integer.MIN_VALUE);
        int dimensionPixelSize = context.getDimensionPixelSize(C0360R.styleable.Toolbar_contentInsetLeft, 0);
        int dimensionPixelSize2 = context.getDimensionPixelSize(C0360R.styleable.Toolbar_contentInsetRight, 0);
        ensureContentInsets();
        ...
        this.mContentInsetStartWithNavigation = context.getDimensionPixelOffset(C0360R.styleable.Toolbar_contentInsetStartWithNavigation, Integer.MIN_VALUE);
        this.mContentInsetEndWithActions = context.getDimensionPixelOffset(C0360R.styleable.Toolbar_contentInsetEndWithActions, Integer.MIN_VALUE);
        this.mCollapseIcon = context.getDrawable(C0360R.styleable.Toolbar_collapseIcon);
        this.mCollapseDescription = context.getText(C0360R.styleable.Toolbar_collapseContentDescription);
        CharSequence text = context.getText(C0360R.styleable.Toolbar_title);
        if (!TextUtils.isEmpty(text)) {
            setTitle(text);
        }
        text = context.getText(C0360R.styleable.Toolbar_subtitle);
        if (!TextUtils.isEmpty(text)) {
            setSubtitle(text);
        }
        this.mPopupContext = getContext();
        setPopupTheme(context.getResourceId(C0360R.styleable.Toolbar_popupTheme, 0));
        Drawable drawable = context.getDrawable(C0360R.styleable.Toolbar_navigationIcon);
        if (drawable != null) {
            setNavigationIcon(drawable);
        }
        text = context.getText(C0360R.styleable.Toolbar_navigationContentDescription);
        if (!TextUtils.isEmpty(text)) {
            setNavigationContentDescription(text);
        }
        drawable = context.getDrawable(C0360R.styleable.Toolbar_logo);
        if (drawable != null) {
            setLogo(drawable);
        }
        text = context.getText(C0360R.styleable.Toolbar_logoDescription);
        if (!TextUtils.isEmpty(text)) {
            setLogoDescription(text);
        }
        if (context.hasValue(C0360R.styleable.Toolbar_titleTextColor) != null) {
            setTitleTextColor(context.getColor(C0360R.styleable.Toolbar_titleTextColor, -1));
        }
        if (context.hasValue(C0360R.styleable.Toolbar_subtitleTextColor) != null) {
            setSubtitleTextColor(context.getColor(C0360R.styleable.Toolbar_subtitleTextColor, -1));
        }
        context.recycle();
    }
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            this.mNavButtonView = new AppCompatImageButton(getContext(), null, C0360R.attr.toolbarNavigationButtonStyle);
            android.view.ViewGroup.LayoutParams generateDefaultLayoutParams = generateDefaultLayoutParams();
    ...
    void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            this.mCollapseButtonView = new AppCompatImageButton(getContext(), null, C0360R.attr.toolbarNavigationButtonStyle);
            ...
            this.mCollapseButtonView.setOnClickListener(new C04203());
        }
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (!shouldLayout(toolbar.mNavButtonView)) {
            ...
            layoutChildRight = layoutChildRight(toolbar.mNavButtonView, i13, iArr, minimumHeight);
            i5 = paddingLeft;
            ...
            if (shouldLayout(toolbar.mExpandedActionView)) {
                if (obj2 == null) {
                    i13 = layoutChildRight(toolbar.mExpandedActionView, i13, iArr, minimumHeight);
                } else {
            ...
            if (shouldLayout(toolbar.mLogoView)) {
                if (obj2 == null) {
                    i13 = layoutChildRight(toolbar.mLogoView, i13, iArr, minimumHeight);
                } else {
            ...
            if (!shouldLayout) {
                if (shouldLayout2) {
                    ...
                    size = toolbar.mTempViews.size();
                    for (max = 0; max < size; max++) {
                        i13 = layoutChildRight((View) toolbar.mTempViews.get(max), i13, iArr, minimumHeight);
                    }
...
jadx.core.utils.exceptions.CodegenException: Error generate insn: PHI: (r7_17 'paddingRight' int) = (r7_8 'paddingRight' int), (r7_16 'paddingRight' int), (r7_16 'paddingRight' int) binds: {(r7_16 'paddingRight' int)=B:100:0x0296, (r7_16 'paddingRight' int)=B:99:0x0294, (r7_8 'paddingRight' int)=B:46:0x0128} in method: android.support.v7.widget.Toolbar.onLayout(boolean, int, int, int, int):void, dex: classes.dex
