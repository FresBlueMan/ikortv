...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    private final OnItemTouchListener mOnItemTouchListener = new C09832();
    View mOverdrawChild = null;
    int mOverdrawChildPosition = -1;
    final List<View> mPendingCleanup = new ArrayList();
    List<RecoverAnimation> mRecoverAnimations = new ArrayList();
    RecyclerView mRecyclerView;
    final Runnable mScrollRunnable = new C04261();
    ...
    public static abstract class Callback {
        ...
        private static final Interpolator sDragScrollInterpolator = new C04281();
        private static final Interpolator sDragViewScrollCapInterpolator = new C04292();
        private static final ItemTouchUIUtil sUICallback;
        private int mCachedMaxScrollSpeed = -1;

        /* renamed from: android.support.v7.widget.helper.ItemTouchHelper$Callback$1 */
        static class C04281 implements Interpolator {
        ...
        static class C04292 implements Interpolator {
            public float getInterpolation(float f) {
                f -= 1.0f;
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (this.mCachedMaxScrollSpeed == -1) {
                this.mCachedMaxScrollSpeed = recyclerView.getResources().getDimensionPixelSize(C0361R.dimen.item_touch_helper_max_drag_scroll_per_frame);
            }
        ...
        public long getAnimationDuration(RecyclerView recyclerView, int i, float f, float f2) {
            ...
            if (recyclerView == null) {
                return i == 8 ? 200 : DEFAULT_SWIPE_ANIMATION_DURATION;
            }
            if (i == 8) {
    ...
    private static class RecoverAnimation implements AnimatorListener {
        ...
        class C04301 implements AnimatorUpdateListener {
            C04301() {
            }
    ...
    class C09832 implements OnItemTouchListener {
        C09832() {
        }
    ...
    class C09855 implements ChildDrawingOrderCallback {
        C09855() {
        }
    ...
    public void attachToRecyclerView(@Nullable RecyclerView recyclerView) {
        if (this.mRecyclerView != recyclerView) {
            ...
            if (this.mRecyclerView != null) {
                ...
                this.mSwipeEscapeVelocity = recyclerView.getDimension(C0361R.dimen.item_touch_helper_swipe_escape_velocity);
                this.mMaxSwipeVelocity = recyclerView.getDimension(C0361R.dimen.item_touch_helper_swipe_escape_max_velocity);
                setupCallbacks();
            }
        }
    }
        ...
        if (viewHolder2 != this.mSelected || i2 != r11.mActionState) {
            ...
            if (r11.mSelected != null) {
                ...
                if (viewHolder3.itemView.getParent() != null) {
                    ...
                    RecoverAnimation c09843 = new RecoverAnimation(viewHolder3, i6, i3, f2, f3, f, signum) {
                        public void onAnimationEnd(Animator animator) {
                    ...
                    if (r0.mDy > 0.0f) {
                        ...
                        if (i3 > 0) {
                            ...
                            if (i3 != 0) {
                                ...
                                i2 = i3;
                                i3 = i4;
                                interpolateOutOfBoundsScroll = r0.mCallback.interpolateOutOfBoundsScroll(r0.mRecyclerView, r0.mSelected.itemView.getHeight(), i2, r0.mRecyclerView.getHeight(), j);
                                i2 = i3;
    ...
    private void addChildDrawingOrderCallback() {
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new C09855();
            }
