...
public class PopupMenu {
    ...
    class C03982 implements android.widget.PopupWindow.OnDismissListener {
        C03982() {
        }
    ...
    class C09741 implements Callback {
    ...
    public PopupMenu(@NonNull Context context, @NonNull View view, int i) {
        this(context, view, i, C0360R.attr.popupMenuStyle, 0);
    }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View view, int i, @AttrRes int i2, @StyleRes int i3) {
        ...
        this.mMenu.setCallback(new C09741());
        this.mPopup = new MenuPopupHelper(context, this.mMenu, view, false, i2, i3);
        this.mPopup.setGravity(i);
        this.mPopup.setOnDismissListener(new C03982());
    }
