...
public class ActionBarOverlayLayout extends ViewGroup implements NestedScrollingParent, DecorContentParent {
    static final int[] ATTRS = new int[]{C0360R.attr.actionBarSize, 16842841};
    ...
    class C03753 implements Runnable {
        C03753() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mTopAnimatorListener = new C03731();
        this.mRemoveActionBarHideOffset = new C03742();
        this.mAddActionBarHideOffset = new C03753();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0360R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0360R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0360R.id.action_bar));
        }
    }
