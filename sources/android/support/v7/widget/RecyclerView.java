...
import android.support.v7.recyclerview.C0361R;
...
public class RecyclerView extends ViewGroup implements NestedScrollingChild2, ScrollingView {
    ...
    static final Interpolator sQuinticInterpolator = new C04013();
    ...
    static class C04013 implements Interpolator {
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C09791();
        ...
        private final Callback mVerticalBoundCheckCallback = new C09802();
        private int mWidth;
        ...
        class C09791 implements Callback {
            C09791() {
            }
        ...
        class C09802 implements Callback {
            C09802() {
            }
        ...
        public boolean isViewPartiallyVisible(@NonNull View view, boolean z, boolean z2) {
            view = (!this.mHorizontalBoundCheck.isViewWithinBoundFlags(view, 24579) || this.mVerticalBoundCheck.isViewWithinBoundFlags(view, 24579) == null) ? null : true;
        ...
        public void onInitializeAccessibilityNodeInfoForItem(Recycler recycler, State state, View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            accessibilityNodeInfoCompat.setCollectionItemInfo(CollectionItemInfoCompat.obtain(canScrollVertically() != null ? getPosition(view) : 0, 1, canScrollHorizontally() != null ? getPosition(view) : 0, 1, false, false));
        }
        ...
        public static Properties getProperties(Context context, AttributeSet attributeSet, int i, int i2) {
            ...
            context = context.obtainStyledAttributes(attributeSet, C0361R.styleable.RecyclerView, i, i2);
            properties.orientation = context.getInt(C0361R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = context.getInt(C0361R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = context.getBoolean(C0361R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = context.getBoolean(C0361R.styleable.RecyclerView_stackFromEnd, false);
            context.recycle();
            return properties;
        }
                ...
                if (changedScrapViewForPosition != null) {
                    ...
                    if (changedScrapViewForPosition == null) {
                        ...
                        if (changedScrapViewForPosition == null && recycler.mViewCacheExtension != null) {
                            View viewForPositionAndType = recycler.mViewCacheExtension.getViewForPositionAndType(recycler, i2, itemViewType);
                        ...
                        if (changedScrapViewForPosition == null) {
                            ...
                            obj2 = obj;
                            if (!(obj2 == null || RecyclerView.this.mState.isPreLayout() || !viewHolder.hasAnyOfTheFlags(8192))) {
                            ...
                            if (RecyclerView.this.mState.isPreLayout() || !viewHolder.isBound()) {
                                ...
                                z2 = tryBindViewHolderByDeadline(viewHolder, RecyclerView.this.mAdapterHelper.findPositionOffset(i2), i, j);
    ...
    class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                Object obj = (i4 != 0 && RecyclerView.this.mLayout.canScrollVertically() && scrollVerticallyBy == i4) ? 1 : null;
                Object obj2 = (i3 != 0 && RecyclerView.this.mLayout.canScrollHorizontally() && scrollHorizontallyBy == i3) ? 1 : null;
                if (!(i3 == 0 && i4 == 0) && obj2 == null) {
                    if (obj == null) {
                        obj2 = null;
                        if (!overScroller.isFinished()) {
                            if (obj2 == null || RecyclerView.this.hasNestedScrollingParent(1)) {
                                postOnAnimation();
    ...
    class C09764 implements ProcessCallback {
        C09764() {
        }
    ...
    class C09775 implements Callback {
        C09775() {
        }
    ...
    class C09786 implements Callback {
        C09786() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C04021();
        Parcelable mLayoutState;

        /* renamed from: android.support.v7.widget.RecyclerView$SavedState$1 */
        static class C04021 implements ClassLoaderCreator<SavedState> {
            C04021() {
            }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mUpdateChildViewsRunnable = new C03991();
        ...
        this.mItemAnimatorRunner = new C04002();
        this.mViewInfoProcessCallback = new C09764();
        ...
        if (attributeSet != null) {
            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0361R.styleable.RecyclerView, i, 0);
            String string = obtainStyledAttributes.getString(C0361R.styleable.RecyclerView_layoutManager);
            if (obtainStyledAttributes.getInt(C0361R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = obtainStyledAttributes.getBoolean(C0361R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) obtainStyledAttributes.getDrawable(C0361R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes.getDrawable(C0361R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes.getDrawable(C0361R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes.getDrawable(C0361R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
            obtainStyledAttributes.recycle();
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C09775());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C09786());
    }
    ...
    private boolean isPreferredNextFocusAbsolute(View view, View view2, int i) {
        ...
        if (i == 17) {
            ...
            view2.append("direction must be absolute. received:");
            view2.append(i);
    ...
    void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        FastScroller fastScroller = new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0361R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0361R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0361R.dimen.fastscroll_margin));
    }
