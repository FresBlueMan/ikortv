...
public class StaggeredGridLayoutManager extends LayoutManager implements ScrollVectorProvider {
    ...
    static class LazySpanLookup {
        ...
        static class FullSpanItem implements Parcelable {
            public static final Creator<FullSpanItem> CREATOR = new C04161();
            int mGapDir;
            int[] mGapPerSpan;
            ...
            static class C04161 implements Creator<FullSpanItem> {
                C04161() {
                }
    ...
    public StaggeredGridLayoutManager(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mCheckForGapsRunnable = new C04151();
    ...
    private int fill(Recycler recycler, LayoutState layoutState, State state) {
        ...
        if (this.mLayoutState.mInfinite) {
            i = layoutState2.mLayoutDirection == 1 ? ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED : Integer.MIN_VALUE;
        } else {
        ...
        if (r6.mShouldReverseLayout) {
            i2 = r6.mPrimaryOrientation.getEndAfterPadding();
        } else {
            i2 = r6.mPrimaryOrientation.getStartAfterPadding();
        }
        int i3 = i2;
        Object obj = null;
        while (layoutState.hasMore(state) && (r6.mLayoutState.mInfinite || !r6.mRemainingSpans.isEmpty())) {
            ...
            if (layoutParams.mFullSpan && layoutState2.mItemDirection == -1) {
                if (obj2 != null) {
                    ...
                    if ((span ^ 1) != 0) {
                        FullSpanItem fullSpanItem = r6.mLazySpanLookup.getFullSpanItem(i2);
                        if (fullSpanItem != null) {
            ...
            if (isLayoutRTL() && r6.mOrientation == 1) {
                if (layoutParams.mFullSpan) {
                    i2 = r6.mSecondaryOrientation.getEndAfterPadding();
                } else {
                    i2 = r6.mSecondaryOrientation.getEndAfterPadding() - (((r6.mSpanCount - 1) - span2.mIndex) * r6.mSizePerSpan);
                }
                i5 = i2;
                decoratedMeasurement2 = i2 - r6.mSecondaryOrientation.getDecoratedMeasurement(next);
            } else {
                if (layoutParams.mFullSpan) {
                    i2 = r6.mSecondaryOrientation.getStartAfterPadding();
                } else {
                    i2 = (span2.mIndex * r6.mSizePerSpan) + r6.mSecondaryOrientation.getStartAfterPadding();
                }
                decoratedMeasurement2 = i2;
                i5 = r6.mSecondaryOrientation.getDecoratedMeasurement(next) + i2;
            }
            ...
            if (layoutParams.mFullSpan) {
                updateAllRemainingSpans(r6.mLayoutState.mLayoutDirection, i);
            } else {
                updateRemainingSpans(span2, r6.mLayoutState.mLayoutDirection, i);
            }
