        ...
        while (true) {
            ...
            if (next == 2 && depth2 <= depth) {
                if (xmlPullParser.getName().equals("item")) {
                    TypedArray obtainAttributes = obtainAttributes(resources, theme, attributeSet2, C0360R.styleable.ColorStateListItem);
                    int color = obtainAttributes.getColor(C0360R.styleable.ColorStateListItem_android_color, -65281);
                    float f = 1.0f;
                    if (obtainAttributes.hasValue(C0360R.styleable.ColorStateListItem_android_alpha)) {
                        f = obtainAttributes.getFloat(C0360R.styleable.ColorStateListItem_android_alpha, 1.0f);
                    } else if (obtainAttributes.hasValue(C0360R.styleable.ColorStateListItem_alpha)) {
                        f = obtainAttributes.getFloat(C0360R.styleable.ColorStateListItem_alpha, 1.0f);
                    }
                    ...
                    for (int i4 = 0; i4 < next; i4++) {
                        ...
                        if (!(attributeNameResource == 16843173 || attributeNameResource == 16843551 || attributeNameResource == C0360R.attr.alpha)) {
                            i = i3 + 1;
