...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    public MainThreadCallback<T> getMainThreadProxy(final MainThreadCallback<T> mainThreadCallback) {
        return new MainThreadCallback<T>() {
            ...
            private Runnable mMainThreadRunnable = new C03631();
            ...
            class C03631 implements Runnable {
                ...
                public void run() {
                    SyncQueueItem next = C09631.this.mQueue.next();
                    while (next != null) {
                        switch (next.what) {
                            case 1:
    ...
    public BackgroundCallback<T> getBackgroundProxy(final BackgroundCallback<T> backgroundCallback) {
        return new BackgroundCallback<T>() {
            ...
            private Runnable mBackgroundRunnable = new C03641();
            ...
            class C03641 implements Runnable {
                ...
                public void run() {
                    while (true) {
                        SyncQueueItem next = C09642.this.mQueue.next();
                        if (next != null) {
                            switch (next.what) {
                                case 1:
                                    C09642.this.mQueue.removeMessages(1);
                                    backgroundCallback.refresh(next.arg1);
                                    break;
                                case 2:
                                    C09642.this.mQueue.removeMessages(2);
                                    C09642.this.mQueue.removeMessages(3);
                        ...
                        C09642.this.mBackgroundRunning.set(false);
                        return;
                    }
                }
            }
