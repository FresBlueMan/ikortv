...
public class DiffUtil {
    private static final Comparator<Snake> SNAKE_COMPARATOR = new C03621();

    /* renamed from: android.support.v7.util.DiffUtil$1 */
    static class C03621 implements Comparator<Snake> {
        C03621() {
        }
    ...
    public static class DiffResult {
        ...
        private boolean findMatchingItem(int i, int i2, int i3, boolean z) {
            ...
            while (i3 >= 0) {
                ...
                int i6 = snake.f349x + snake.size;
                int i7 = snake.f350y + snake.size;
                int i8 = 4;
                if (z) {
                    for (i4--; i4 >= i6; i4--) {
        ...
        public void dispatchUpdatesTo(ListUpdateCallback listUpdateCallback) {
            ...
            for (int size = this.mSnakes.size() - 1; size >= 0; size--) {
                ...
                for (i3--; i3 >= 0; i3--) {
                    if ((this.mOldItemStatuses[snake.f349x + i3] & 31) == 2) {
                        listUpdateCallback.onChanged(snake.f349x + i3, 1, this.mCallback.getChangePayload(snake.f349x + i3, snake.f350y + i3));
                    }
                }
                i = snake.f349x;
                i2 = snake.f350y;
                    ...
                    while (i17 <= i12) {
                        if (i17 != i16) {
                            ...
                            if (obj != null || i17 < (i9 - i12) + 1 || i17 > (i9 + i12) - 1 || iArr3[i6] < iArr4[i6]) {
                                ...
                                snake = new Snake();
                                snake.f349x = iArr4[i6];
                                snake.f350y = snake.f349x - i17;
                    ...
                    for (i7 = i16; i7 <= i12; i7 += 2) {
                        ...
                        if (i8 != i12 + i9) {
                            ...
                            if (obj == null || i8 < i16 || i8 > i12 || iArr3[i19] < iArr4[i19]) {
                                ...
                                snake = new Snake();
                                snake.f349x = iArr4[i19];
                                snake.f350y = snake.f349x - i8;
                                snake.size = iArr3[i19] - iArr4[i19];
                                snake.removal = z;
                                snake.reverse = true;
                                return snake;
                            }
