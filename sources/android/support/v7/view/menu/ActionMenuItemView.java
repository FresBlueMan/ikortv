...
public class ActionMenuItemView extends AppCompatTextView implements ItemView, ActionMenuChildView, OnClickListener {
    ...
    public ActionMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        context = context.obtainStyledAttributes(attributeSet, C0360R.styleable.ActionMenuItemView, i, 0);
        this.mMinWidth = context.getDimensionPixelSize(C0360R.styleable.ActionMenuItemView_android_minWidth, 0);
        context.recycle();
        this.mMaxIconSize = (int) ((resources.getDisplayMetrics().density * 1107296256) + 1056964608);
