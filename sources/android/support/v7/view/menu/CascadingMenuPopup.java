...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, OnKeyListener, OnDismissListener {
    ...
    private final OnAttachStateChangeListener mAttachStateChangeListener = new C03662();
    private final Context mContext;
    private int mDropDownGravity = 0;
    private boolean mForceShowIcon;
    private final OnGlobalLayoutListener mGlobalLayoutListener = new C03651();
    private boolean mHasXOffset;
    private boolean mHasYOffset;
    private int mLastPosition;
    private final MenuItemHoverListener mMenuItemHoverListener = new C09653();
    ...
    class C03651 implements OnGlobalLayoutListener {
        C03651() {
        }
    ...
    class C03662 implements OnAttachStateChangeListener {
    ...
    class C09653 implements MenuItemHoverListener {
        C09653() {
        }
    ...
    public CascadingMenuPopup(@NonNull Context context, @NonNull View view, @AttrRes int i, @StyleRes int i2, boolean z) {
        ...
        this.mMenuMaxWidth = Math.max(context.getDisplayMetrics().widthPixels / 2, context.getDimensionPixelSize(C0360R.dimen.abc_config_prefDialogWidth));
    ...
    private void showMenu(@NonNull MenuBuilder menuBuilder) {
        ...
        if (findParentViewForSubmenu != null) {
            ...
            i = (this.mDropDownGravity & 5) == 5 ? obj != null ? i + measureIndividualMenuWidth : i - findParentViewForSubmenu.getWidth() : obj != null ? i + findParentViewForSubmenu.getWidth() : i - measureIndividualMenuWidth;
        ...
        if (cascadingMenuInfo == null && this.mShowTitle && menuBuilder.getHeaderTitle() != null) {
            FrameLayout frameLayout = (FrameLayout) from.inflate(C0360R.layout.abc_popup_menu_header_item_layout, listView, false);
