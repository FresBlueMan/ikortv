...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C12921();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C12932();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C09593();

    /* renamed from: android.support.v7.app.WindowDecorActionBar$3 */
    class C09593 implements ViewPropertyAnimatorUpdateListener {
        C09593() {
        }
    ...
    class C12921 extends ViewPropertyAnimatorListenerAdapter {
        C12921() {
        }
    ...
    class C12932 extends ViewPropertyAnimatorListenerAdapter {
        C12932() {
        }
    ...
    private void init(View view) {
        this.mOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0360R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0360R.id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0360R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) view.findViewById(C0360R.id.action_bar_container);
        ...
        view = (this.mDecorToolbar.getDisplayOptions() & 4) != null ? true : null;
        if (view != null) {
        ...
        if (!actionBarPolicy.enableHomeButtonByDefault()) {
            if (view == null) {
                ...
                view = this.mContext.obtainStyledAttributes(null, C0360R.styleable.ActionBar, C0360R.attr.actionBarStyle, 0);
                if (view.getBoolean(C0360R.styleable.ActionBar_hideOnContentScroll, false)) {
                    setHideOnContentScrollEnabled(true);
                }
                dimensionPixelSize = view.getDimensionPixelSize(C0360R.styleable.ActionBar_elevation, 0);
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0360R.attr.actionBarWidgetTheme, typedValue, true);
