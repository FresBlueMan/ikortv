...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
    ...
    class C01991 implements Callback {
        C01991() {
        }
    ...
    class C02002 extends AnimatorListenerAdapter {
        C02002() {
        }
    ...
    public static AnimatedVectorDrawableCompat create(@NonNull Context context, @DrawableRes int i) {
        ...
        try {
            ...
            while (true) {
                ...
                if (next == 2 || next == 1) {
                    if (next == 2) {
                        return createFromXmlInner(context, context.getResources(), i, asAttributeSet, context.getTheme());
                    }
        ...
        if (this.mDelegateDrawable != null) {
            ...
            if (!this.mAnimationCallbacks.contains(animationCallback)) {
                ...
                if (this.mAnimatorListener == null) {
                    this.mAnimatorListener = new C02002();
                }
