...
*/
        ...
        public void printBitmap(String str, Uri uri, OnPrintFinishCallback onPrintFinishCallback) {
            ...
            final Uri uri2 = uri;
            final OnPrintFinishCallback onPrintFinishCallback2 = onPrintFinishCallback;
            PrintDocumentAdapter c02883 = new PrintDocumentAdapter() {
                private PrintAttributes mAttributes;
                Bitmap mBitmap = null;
                ...
                public void onLayout(PrintAttributes printAttributes, PrintAttributes printAttributes2, CancellationSignal cancellationSignal, LayoutResultCallback layoutResultCallback, Bundle bundle) {
                    ...
                    if (cancellationSignal.isCanceled() != null) {
                        ...
                        this.mLoadBitmap = new AsyncTask<Uri, Boolean, Bitmap>() {
                            ...
                            class C02861 implements OnCancelListener {
                                C02861() {
                                }

                                public void onCancel() {
                                    C02883.this.cancelLoad();
                                    C02871.this.cancel(false);
                                }
                            }

                            protected void onPreExecute() {
                                cancellationSignal2.setOnCancelListener(new C02861());
                            }
...
*/
                                /*
                                r1 = this;
                                r2 = android.support.v4.print.PrintHelper.PrintHelperApi19.C02883.this;	 Catch:{ FileNotFoundException -> 0x000d }
                                r2 = android.support.v4.print.PrintHelper.PrintHelperApi19.this;	 Catch:{ FileNotFoundException -> 0x000d }
                                r0 = android.support.v4.print.PrintHelper.PrintHelperApi19.C02883.this;	 Catch:{ FileNotFoundException -> 0x000d }
            ...
            if (this.mOrientation != 1) {
                if (this.mOrientation != 0) {
                    ...
                    printManager.print(str, c02883, onPrintFinishCallback.build());
                }
            }
