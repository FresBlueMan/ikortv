...
*/
                    ...
                    L_0x0034:
                        ...
                        r0 = r3;	 Catch:{ RemoteException -> 0x0062 }
                        r0.onConnectFailed();	 Catch:{ RemoteException -> 0x0062 }
                        goto L_0x00c5;
                    L_0x0062:
                        r0 = "MBServiceCompat";
                        r1 = new java.lang.StringBuilder;
                        ...
                        goto L_0x00c5;
                    L_0x007b:
                        r2 = android.support.v4.media.MediaBrowserServiceCompat.ServiceBinderImpl.this;	 Catch:{ RemoteException -> 0x00a4 }
                        r2 = android.support.v4.media.MediaBrowserServiceCompat.this;	 Catch:{ RemoteException -> 0x00a4 }
                        r2 = r2.mConnections;	 Catch:{ RemoteException -> 0x00a4 }
                        r2.put(r0, r1);	 Catch:{ RemoteException -> 0x00a4 }
                        r2 = android.support.v4.media.MediaBrowserServiceCompat.ServiceBinderImpl.this;	 Catch:{ RemoteException -> 0x00a4 }
                        r2 = android.support.v4.media.MediaBrowserServiceCompat.this;	 Catch:{ RemoteException -> 0x00a4 }
                        r2 = r2.mSession;	 Catch:{ RemoteException -> 0x00a4 }
                        if (r2 == 0) goto L_0x00c5;	 Catch:{ RemoteException -> 0x00a4 }
                    L_0x008c:
                        r2 = r3;	 Catch:{ RemoteException -> 0x00a4 }
                        r3 = r1.root;	 Catch:{ RemoteException -> 0x00a4 }
                        r3 = r3.getRootId();	 Catch:{ RemoteException -> 0x00a4 }
                        r4 = android.support.v4.media.MediaBrowserServiceCompat.ServiceBinderImpl.this;	 Catch:{ RemoteException -> 0x00a4 }
                        r4 = android.support.v4.media.MediaBrowserServiceCompat.this;	 Catch:{ RemoteException -> 0x00a4 }
                        r4 = r4.mSession;	 Catch:{ RemoteException -> 0x00a4 }
                        r1 = r1.root;	 Catch:{ RemoteException -> 0x00a4 }
                        r1 = r1.getExtras();	 Catch:{ RemoteException -> 0x00a4 }
                        r2.onConnect(r3, r4, r1);	 Catch:{ RemoteException -> 0x00a4 }
                        goto L_0x00c5;
                    L_0x00a4:
                        r1 = "MBServiceCompat";
...
*/
    ...
    void performLoadChildren(String str, ConnectionRecord connectionRecord, Bundle bundle) {
        ...
        final String str2 = str;
        final Bundle bundle2 = bundle;
        Result c09331 = new Result<List<MediaItem>>(str) {
...
*/
        ...
        if (bundle == null) {
            onLoadChildren(str, c09331);
        } else {
            onLoadChildren(str, c09331, bundle);
        }
        this.mCurConnection = null;
        if (c09331.isDone() == null) {
            StringBuilder stringBuilder = new StringBuilder();
    ...
    void performLoadItem(String str, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        Result c09342 = new Result<MediaItem>(str) {
            void onResultSent(MediaItem mediaItem) {
                if ((getFlags() & 2) != 0) {
        ...
        this.mCurConnection = connectionRecord;
        onLoadItem(str, c09342);
        this.mCurConnection = null;
        if (c09342.isDone() == null) {
    ...
    void performSearch(String str, Bundle bundle, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        Result c09353 = new Result<List<MediaItem>>(str) {
            void onResultSent(List<MediaItem> list) {
                if ((getFlags() & 4) == 0) {
                    if (list != null) {
                        Bundle bundle = new Bundle();
        ...
        this.mCurConnection = connectionRecord;
        onSearch(str, bundle, c09353);
        this.mCurConnection = null;
        if (c09353.isDone() == null) {
    ...
    void performCustomAction(String str, Bundle bundle, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        Result c09364 = new Result<Bundle>(str) {
        ...
        this.mCurConnection = connectionRecord;
        onCustomAction(str, bundle, c09364);
        this.mCurConnection = null;
        if (c09364.isDone() == null) {
            resultReceiver = new StringBuilder();
