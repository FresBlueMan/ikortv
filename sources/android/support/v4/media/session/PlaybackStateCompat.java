...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C02801();
    ...
    static class C02801 implements Creator<PlaybackStateCompat> {
        C02801() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C02811();
        ...
        static class C02811 implements Creator<CustomAction> {
            C02811() {
            }
