...
public abstract class AbsSavedState implements Parcelable {
    public static final Creator<AbsSavedState> CREATOR = new C03082();
    public static final AbsSavedState EMPTY_STATE = new C09481();
    private final Parcelable mSuperState;

    /* renamed from: android.support.v4.view.AbsSavedState$2 */
    static class C03082 implements ClassLoaderCreator<AbsSavedState> {
        C03082() {
        }
    ...
    static class C09481 extends AbsSavedState {
        C09481() {
            super();
        }
    }
