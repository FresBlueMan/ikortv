...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C03161();
    ...
    private static final Interpolator sInterpolator = new C03172();
    ...
    private final Runnable mEndScrollRunnable = new C03183();
    ...
    static class C03161 implements Comparator<ItemInfo> {
        C03161() {
        }
    ...
    static class C03172 implements Interpolator {
    ...
    class C03183 implements Runnable {
        C03183() {
        }
    ...
    static class ViewPositionComparator implements Comparator<View> {
        ...
        public int compare(View view, View view2) {
            ...
            return layoutParams.isDecor != null ? true : -1;
        }
    }

    /* renamed from: android.support.v4.view.ViewPager$4 */
    class C09494 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C03191();
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        /* renamed from: android.support.v4.view.ViewPager$SavedState$1 */
        static class C03191 implements ClassLoaderCreator<SavedState> {
            C03191() {
            }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C09494());
    }
...
*/
    ...
    L_0x0219:
        return;
    L_0x021a:
        r1 = r17.getResources();	 Catch:{ NotFoundException -> 0x0227 }
        r2 = r17.getId();	 Catch:{ NotFoundException -> 0x0227 }
        r1 = r1.getResourceName(r2);	 Catch:{ NotFoundException -> 0x0227 }
        goto L_0x022f;
    L_0x0227:
        r1 = r17.getId();
