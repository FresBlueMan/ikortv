...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C02341();
...
*/
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C09292();

    /* renamed from: android.support.v4.content.ModernAsyncTask$1 */
    static class C02341 implements ThreadFactory {
    ...
    class C09292 extends WorkerRunnable<Params, Result> {
        C09292() {
        }
