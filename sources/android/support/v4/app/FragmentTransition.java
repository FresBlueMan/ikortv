...
class FragmentTransition {
    ...
    private static void configureTransitionsOrdered(FragmentManagerImpl fragmentManagerImpl, int i, FragmentContainerTransition fragmentContainerTransition, View view, ArrayMap<String, String> arrayMap) {
        ...
        if (view3 != null) {
            ...
            exitTransition = configureSharedElementsOrdered(view3, view, arrayMap, fragmentContainerTransition, arrayList3, arrayList4, enterTransition, exitTransition);
            ...
            obj = obj4;
            arrayList6 = configureEnteringExitingViews(obj, fragment2, arrayList6, view2);
            if (arrayList6 != null) {
                if (!arrayList6.isEmpty()) {
                    ...
                    if (mergeTransitions != null) {
                        ...
                        FragmentTransitionCompat21.scheduleRemoveTargets(mergeTransitions, enterTransition, arrayList, obj2, arrayList6, exitTransition, arrayList5);
                        obj3 = mergeTransitions;
                        scheduleTargetChange(view3, fragment, view, arrayList5, enterTransition, arrayList, obj2, arrayList6);
                        arrayList2 = arrayList5;
                        FragmentTransitionCompat21.setNameOverridesOrdered(view3, arrayList2, arrayMap2);
                        FragmentTransitionCompat21.beginDelayedTransition(view3, obj3);
                        FragmentTransitionCompat21.scheduleNameReset(view3, arrayList2, arrayMap2);
                    }
                }
            }
            obj2 = null;
    ...
    private static void scheduleTargetChange(ViewGroup viewGroup, Fragment fragment, View view, ArrayList<View> arrayList, Object obj, ArrayList<View> arrayList2, Object obj2, ArrayList<View> arrayList3) {
        ...
        OneShotPreDrawListener.add(viewGroup, c02192);
    }
    ...
    private static Object configureSharedElementsOrdered(ViewGroup viewGroup, View view, ArrayMap<String, String> arrayMap, FragmentContainerTransition fragmentContainerTransition, ArrayList<View> arrayList, ArrayList<View> arrayList2, Object obj, Object obj2) {
        ...
        if (fragment != null) {
            if (fragment2 != null) {
                ...
                ViewGroup viewGroup2 = viewGroup;
                OneShotPreDrawListener.add(viewGroup, c02214);
                return obj6;
            }
        }
        return null;
