...
public class Fragment implements C0188c, ComponentCallbacks, OnCreateContextMenuListener {
    ...
    C0921d mLifecycleRegistry = new C0921d(this);
    ...
    public static class SavedState implements Parcelable {
        ...
        static class C02091 implements Creator<SavedState> {
            C02091() {
            }
    ...
    class C09242 extends FragmentContainer {
        C09242() {
        }
...
*/
        ...
        if (this.mFragmentManager != null) {
            if (this.mFragmentManager.mHost != null) {
                if (Looper.myLooper() != this.mFragmentManager.mHost.getHandler().getLooper()) {
                    this.mFragmentManager.mHost.getHandler().postAtFrontOfQueue(new C02081());
                    return;
                } else {
    ...
    void instantiateChildFragmentManager() {
        if (this.mHost != null) {
            ...
            this.mChildFragmentManager.attachController(this.mHost, new C09242(), this);
            return;
        }
    ...
    void performCreate(Bundle bundle) {
        ...
        if (this.mCalled != null) {
            this.mLifecycleRegistry.m1945a(C0185a.ON_CREATE);
            return;
        }
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("Fragment ");
    ...
    void performStart() {
        ...
        if (this.mCalled) {
            ...
            this.mLifecycleRegistry.m1945a(C0185a.ON_START);
            return;
        }
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("Fragment ");
    ...
    void performResume() {
        ...
        if (this.mCalled) {
            ...
            this.mLifecycleRegistry.m1945a(C0185a.ON_RESUME);
            return;
        }
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("Fragment ");
    ...
    void performPause() {
        this.mLifecycleRegistry.m1945a(C0185a.ON_PAUSE);
        if (this.mChildFragmentManager != null) {
    ...
    void performStop() {
        this.mLifecycleRegistry.m1945a(C0185a.ON_STOP);
        if (this.mChildFragmentManager != null) {
    ...
    void performDestroy() {
        this.mLifecycleRegistry.m1945a(C0185a.ON_DESTROY);
        if (this.mChildFragmentManager != null) {
