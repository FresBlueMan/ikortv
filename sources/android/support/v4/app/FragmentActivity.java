...
public class FragmentActivity extends BaseFragmentActivityApi16 implements OnRequestPermissionsResultCallback, RequestPermissionsRequestCodeValidator {
    ...
    final Handler mHandler = new C02101();
    ...
    protected void onSaveInstanceState(Bundle bundle) {
        ...
        markState(getSupportFragmentManager(), C0186b.CREATED);
    ...
    private static void markState(FragmentManager fragmentManager, C0186b c0186b) {
        for (Fragment fragment : fragmentManager.getFragments()) {
            if (fragment != null) {
                fragment.mLifecycleRegistry.m1946a(c0186b);
                markState(fragment.getChildFragmentManager(), c0186b);
            }
        }
    }
}
