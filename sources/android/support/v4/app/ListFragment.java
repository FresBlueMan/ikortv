...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C02322();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C02311();
    ...
    class C02322 implements OnItemClickListener {
        C02322() {
        }
