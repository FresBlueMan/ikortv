...
final class BackStackState implements Parcelable {
    public static final Creator<BackStackState> CREATOR = new C02071();
    ...
    static class C02071 implements Creator<BackStackState> {
        C02071() {
        }
    ...
    public BackStackState(BackStackRecord backStackRecord) {
        ...
        if (backStackRecord.mAddToBackStack) {
            ...
            int i2 = 0;
            while (i < size) {
                Op op = (Op) backStackRecord.mOps.get(i);
                int i3 = i2 + 1;
                this.mOps[i2] = op.cmd;
                int i4 = i3 + 1;
