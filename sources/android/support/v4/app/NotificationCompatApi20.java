...
class NotificationCompatApi20 {
    ...
    public static class Builder implements NotificationBuilderWithActions, NotificationBuilderWithBuilderAccessor {
        /* renamed from: b */
        private android.app.Notification.Builder f1709b;
        ...
        public Builder(Context context, Notification notification, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, RemoteViews remoteViews, int i, PendingIntent pendingIntent, PendingIntent pendingIntent2, Bitmap bitmap, int i2, int i3, boolean z, boolean z2, boolean z3, int i4, CharSequence charSequence4, boolean z4, ArrayList<String> arrayList, Bundle bundle, String str, boolean z5, String str2, RemoteViews remoteViews2, RemoteViews remoteViews3, int i5) {
            ...
            int i6 = i;
            builder.f1709b = largeIcon.setNumber(i).setUsesChronometer(z3).setPriority(i4).setProgress(i2, i3, z).setLocalOnly(z4).setGroup(str).setGroupSummary(z5).setSortKey(str2);
            builder.mExtras = new Bundle();
            if (bundle2 != null) {
                builder.mExtras.putAll(bundle2);
            }
            if (!(arrayList2 == null || arrayList.isEmpty())) {
                builder.mExtras.putStringArray(NotificationCompat.EXTRA_PEOPLE, (String[]) arrayList2.toArray(new String[arrayList.size()]));
            }
            builder.mContentView = remoteViews2;
            builder.mBigContentView = remoteViews3;
            builder.mGroupAlertBehavior = i5;
        }

        public void addAction(Action action) {
            NotificationCompatApi20.addAction(this.f1709b, action);
        }
        ...
        public Notification build() {
            this.f1709b.setExtras(this.mExtras);
            Notification build = this.f1709b.build();
