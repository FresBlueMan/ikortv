...
import android.support.compat.C0194R;
...
public class NotificationCompat {
    ...
    public static abstract class Style {
        ...
        public RemoteViews applyStandardTemplate(boolean z, int i, boolean z2) {
            ...
            if (VERSION.SDK_INT >= 16 && VERSION.SDK_INT < 21) {
                if (i != 0) {
                    remoteViews.setInt(C0194R.id.notification_background, "setBackgroundResource", C0194R.drawable.notification_bg_low);
                    remoteViews.setInt(C0194R.id.icon, "setBackgroundResource", C0194R.drawable.notification_template_icon_low_bg);
                } else {
                    remoteViews.setInt(C0194R.id.notification_background, "setBackgroundResource", C0194R.drawable.notification_bg);
                    remoteViews.setInt(C0194R.id.icon, "setBackgroundResource", C0194R.drawable.notification_template_icon_bg);
                }
            }
            if (this.mBuilder.mLargeIcon != 0) {
                if (VERSION.SDK_INT >= 16) {
                    remoteViews.setViewVisibility(C0194R.id.icon, 0);
                    remoteViews.setImageViewBitmap(C0194R.id.icon, this.mBuilder.mLargeIcon);
                } else {
                    remoteViews.setViewVisibility(C0194R.id.icon, 8);
                }
                if (z && this.mBuilder.mNotification.icon) {
                    z = resources.getDimensionPixelSize(C0194R.dimen.notification_right_icon_size);
                    i = z - (resources.getDimensionPixelSize(C0194R.dimen.notification_small_icon_background_padding) * 2);
                    if (VERSION.SDK_INT >= 21) {
                        remoteViews.setImageViewBitmap(C0194R.id.right_icon, createIconWithBackground(this.mBuilder.mNotification.icon, z, i, this.mBuilder.getColor()));
                    } else {
                        remoteViews.setImageViewBitmap(C0194R.id.right_icon, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                    }
                    remoteViews.setViewVisibility(C0194R.id.right_icon, 0);
                }
            } else if (z && this.mBuilder.mNotification.icon) {
                remoteViews.setViewVisibility(C0194R.id.icon, 0);
                if (VERSION.SDK_INT >= true) {
                    remoteViews.setImageViewBitmap(C0194R.id.icon, createIconWithBackground(this.mBuilder.mNotification.icon, resources.getDimensionPixelSize(C0194R.dimen.notification_large_icon_width) - resources.getDimensionPixelSize(C0194R.dimen.notification_big_circle_margin), resources.getDimensionPixelSize(C0194R.dimen.notification_small_icon_size_as_large), this.mBuilder.getColor()));
                } else {
                    remoteViews.setImageViewBitmap(C0194R.id.icon, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                }
            }
            if (this.mBuilder.mContentTitle) {
                remoteViews.setTextViewText(C0194R.id.title, this.mBuilder.mContentTitle);
            }
            if (this.mBuilder.mContentText) {
                remoteViews.setTextViewText(C0194R.id.text, this.mBuilder.mContentText);
                z = true;
            } else {
                z = false;
            }
            ...
            if (this.mBuilder.mContentInfo != null) {
                remoteViews.setTextViewText(C0194R.id.info, this.mBuilder.mContentInfo);
                remoteViews.setViewVisibility(C0194R.id.info, 0);
            } else if (this.mBuilder.mNumber > 0) {
                if (this.mBuilder.mNumber > resources.getInteger(C0194R.integer.status_bar_notification_info_maxnum)) {
                    remoteViews.setTextViewText(C0194R.id.info, resources.getString(C0194R.string.status_bar_notification_info_overflow));
                } else {
                    remoteViews.setTextViewText(C0194R.id.info, NumberFormat.getIntegerInstance().format((long) this.mBuilder.mNumber));
                }
                remoteViews.setViewVisibility(C0194R.id.info, 0);
            } else {
                remoteViews.setViewVisibility(C0194R.id.info, 8);
                if (this.mBuilder.mSubText != null && VERSION.SDK_INT >= 16) {
                    remoteViews.setTextViewText(C0194R.id.text, this.mBuilder.mSubText);
                    if (this.mBuilder.mContentText == null) {
                        remoteViews.setTextViewText(C0194R.id.text2, this.mBuilder.mContentText);
                        remoteViews.setViewVisibility(C0194R.id.text2, 0);
                        obj = 1;
                        if (obj != null && VERSION.SDK_INT >= 16) {
                            if (z2) {
                                remoteViews.setTextViewTextSize(C0194R.id.text, 0, (float) resources.getDimensionPixelSize(C0194R.dimen.notification_subtext_size));
                            }
                            remoteViews.setViewPadding(C0194R.id.line1, 0, 0, 0, 0);
                        }
                        if (this.mBuilder.getWhenIfShowing() != 0) {
                            if (this.mBuilder.mUseChronometer != 0 || VERSION.SDK_INT < 16) {
                                remoteViews.setViewVisibility(C0194R.id.time, 0);
                                remoteViews.setLong(C0194R.id.time, "setTime", this.mBuilder.getWhenIfShowing());
                            } else {
                                remoteViews.setViewVisibility(C0194R.id.chronometer, 0);
                                remoteViews.setLong(C0194R.id.chronometer, "setBase", this.mBuilder.getWhenIfShowing() + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
                                remoteViews.setBoolean(C0194R.id.chronometer, "setStarted", true);
                            }
                            i = 1;
                        }
                        remoteViews.setViewVisibility(C0194R.id.right_side, i == 0 ? 0 : 8);
                        i = C0194R.id.line3;
                        if (!z) {
                            i2 = 8;
                        }
                    ...
                    remoteViews.setViewVisibility(C0194R.id.text2, 8);
                }
                obj = null;
                if (z2) {
                    remoteViews.setTextViewTextSize(C0194R.id.text, 0, (float) resources.getDimensionPixelSize(C0194R.dimen.notification_subtext_size));
        ...
        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) {
            int i5 = C0194R.drawable.notification_icon_background;
            if (i4 == 0) {
                i4 = 0;
            }
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            remoteViews.removeAllViews(C0194R.id.notification_main_column);
            remoteViews.addView(C0194R.id.notification_main_column, remoteViews2.clone());
            remoteViews.setViewVisibility(C0194R.id.notification_main_column, 0);
            if (VERSION.SDK_INT >= 21) {
                remoteViews.setViewPadding(C0194R.id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }

        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0194R.id.title, 8);
            remoteViews.setViewVisibility(C0194R.id.text2, 8);
            remoteViews.setViewVisibility(C0194R.id.text, 8);
        }

        private int calculateTopPadding() {
            Resources resources = this.mBuilder.mContext.getResources();
            int dimensionPixelSize = resources.getDimensionPixelSize(C0194R.dimen.notification_top_pad);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0194R.dimen.notification_top_pad_large_text);
    ...
    public static class Action extends android.support.v4.app.NotificationCompatBase.Action {
        @RestrictTo({Scope.LIBRARY_GROUP})
        public static final android.support.v4.app.NotificationCompatBase.Action.Factory FACTORY = new C09261();
        ...
        static class C09261 implements android.support.v4.app.NotificationCompatBase.Action.Factory {
            C09261() {
            }
    ...
    public static final class CarExtender implements Extender {
        ...
        public static class UnreadConversation extends android.support.v4.app.NotificationCompatBase.UnreadConversation {
            static final Factory FACTORY = new C09271();
            ...
            static class C09271 implements Factory {
                C09271() {
                }
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            boolean z2 = true;
            int i = 0;
            RemoteViews applyStandardTemplate = applyStandardTemplate(true, C0194R.layout.notification_template_custom_big, false);
            applyStandardTemplate.removeAllViews(C0194R.id.actions);
            if (z && this.mBuilder.mActions) {
                z = Math.min(this.mBuilder.mActions.size(), 3);
                if (z <= false) {
                    for (boolean z3 = false; z3 < z; z3++) {
                        applyStandardTemplate.addView(C0194R.id.actions, generateActionButton((Action) this.mBuilder.mActions.get(z3)));
                    }
                    if (z2) {
                        i = 8;
                    }
                    applyStandardTemplate.setViewVisibility(C0194R.id.actions, i);
                    applyStandardTemplate.setViewVisibility(C0194R.id.action_divider, i);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), obj != null ? C0194R.layout.notification_action_tombstone : C0194R.layout.notification_action);
            remoteViews.setImageViewBitmap(C0194R.id.action_image, createColoredBitmap(action.getIcon(), this.mBuilder.mContext.getResources().getColor(C0194R.color.notification_action_color_filter)));
            remoteViews.setTextViewText(C0194R.id.action_text, action.title);
            if (obj == null) {
                remoteViews.setOnClickPendingIntent(C0194R.id.action_container, action.actionIntent);
            }
            if (VERSION.SDK_INT >= 15) {
                remoteViews.setContentDescription(C0194R.id.action_container, action.title);
            }
            return remoteViews;
        }
    }
...
*/
                ...
                if (this.mConversationTitle == null) {
                    if (!hasMessagesWithoutSender()) {
                        ...
                        for (size = this.mMessages.size() - 1; size >= 0; size--) {
                            ...
                            makeMessageLine2 = obj == null ? makeMessageLine(message2) : message2.getText();
    ...
    static class NotificationCompatBaseImpl implements NotificationCompatImpl {
        ...
        public static class BuilderBase implements NotificationBuilderWithBuilderAccessor {
            ...
            BuilderBase(Context context, Notification notification, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, RemoteViews remoteViews, int i, PendingIntent pendingIntent, PendingIntent pendingIntent2, Bitmap bitmap, int i2, int i3, boolean z) {
                ...
                android.app.Notification.Builder fullScreenIntent = deleteIntent.setFullScreenIntent(pendingIntent2, z2);
                Bitmap bitmap2 = bitmap;
                int i4 = i;
                this.mBuilder = fullScreenIntent.setLargeIcon(bitmap).setNumber(i).setProgress(i2, i3, z);
            }
    ...
    static class NotificationCompatApi16Impl extends NotificationCompatBaseImpl {
        ...
        public Notification build(Builder builder, BuilderExtender builderExtender) {
            ...
            android.support.v4.app.NotificationCompatJellybean.Builder builder4 = new android.support.v4.app.NotificationCompatJellybean.Builder(builder2.mContext, builder2.mNotification, builder2.mContentTitle, builder2.mContentText, builder2.mContentInfo, builder2.mTickerView, builder2.mNumber, builder2.mContentIntent, builder2.mFullScreenIntent, builder2.mLargeIcon, builder2.mProgressMax, builder2.mProgress, builder2.mProgressIndeterminate, builder2.mUseChronometer, builder2.mPriority, builder2.mSubText, builder2.mLocalOnly, builder2.mExtras, builder2.mGroupKey, builder2.mGroupSummary, builder2.mSortKey, builder2.mContentView, builder2.mBigContentView);
    ...
    static class NotificationCompatApi19Impl extends NotificationCompatApi16Impl {
        ...
        public Notification build(Builder builder, BuilderExtender builderExtender) {
            ...
            android.support.v4.app.NotificationCompatKitKat.Builder builder4 = new android.support.v4.app.NotificationCompatKitKat.Builder(builder2.mContext, builder2.mNotification, builder2.mContentTitle, builder2.mContentText, builder2.mContentInfo, builder2.mTickerView, builder2.mNumber, builder2.mContentIntent, builder2.mFullScreenIntent, builder2.mLargeIcon, builder2.mProgressMax, builder2.mProgress, builder2.mProgressIndeterminate, builder2.mShowWhen, builder2.mUseChronometer, builder2.mPriority, builder2.mSubText, builder2.mLocalOnly, builder2.mPeople, builder2.mExtras, builder2.mGroupKey, builder2.mGroupSummary, builder2.mSortKey, builder2.mContentView, builder2.mBigContentView);
    ...
    static class NotificationCompatApi20Impl extends NotificationCompatApi19Impl {
        ...
        public Notification build(Builder builder, BuilderExtender builderExtender) {
            ...
            android.support.v4.app.NotificationCompatApi20.Builder builder4 = new android.support.v4.app.NotificationCompatApi20.Builder(builder2.mContext, builder2.mNotification, builder2.mContentTitle, builder2.mContentText, builder2.mContentInfo, builder2.mTickerView, builder2.mNumber, builder2.mContentIntent, builder2.mFullScreenIntent, builder2.mLargeIcon, builder2.mProgressMax, builder2.mProgress, builder2.mProgressIndeterminate, builder2.mShowWhen, builder2.mUseChronometer, builder2.mPriority, builder2.mSubText, builder2.mLocalOnly, builder2.mPeople, builder2.mExtras, builder2.mGroupKey, builder2.mGroupSummary, builder2.mSortKey, builder2.mContentView, builder2.mBigContentView, builder.mGroupAlertBehavior);
    ...
    static class NotificationCompatApi21Impl extends NotificationCompatApi20Impl {
        ...
        public Notification build(Builder builder, BuilderExtender builderExtender) {
            ...
            android.support.v4.app.NotificationCompatApi21.Builder builder4 = new android.support.v4.app.NotificationCompatApi21.Builder(builder2.mContext, builder2.mNotification, builder2.mContentTitle, builder2.mContentText, builder2.mContentInfo, builder2.mTickerView, builder2.mNumber, builder2.mContentIntent, builder2.mFullScreenIntent, builder2.mLargeIcon, builder2.mProgressMax, builder2.mProgress, builder2.mProgressIndeterminate, builder2.mShowWhen, builder2.mUseChronometer, builder2.mPriority, builder2.mSubText, builder2.mLocalOnly, builder2.mCategory, builder2.mPeople, builder2.mExtras, builder2.mColor, builder2.mVisibility, builder2.mPublicVersion, builder2.mGroupKey, builder2.mGroupSummary, builder2.mSortKey, builder2.mContentView, builder2.mBigContentView, builder2.mHeadsUpContentView, builder.mGroupAlertBehavior);
    ...
    static class NotificationCompatApi24Impl extends NotificationCompatApi21Impl {
        ...
        public Notification build(Builder builder, BuilderExtender builderExtender) {
            ...
            android.support.v4.app.NotificationCompatApi24.Builder builder4 = new android.support.v4.app.NotificationCompatApi24.Builder(builder2.mContext, builder2.mNotification, builder2.mContentTitle, builder2.mContentText, builder2.mContentInfo, builder2.mTickerView, builder2.mNumber, builder2.mContentIntent, builder2.mFullScreenIntent, builder2.mLargeIcon, builder2.mProgressMax, builder2.mProgress, builder2.mProgressIndeterminate, builder2.mShowWhen, builder2.mUseChronometer, builder2.mPriority, builder2.mSubText, builder2.mLocalOnly, builder2.mCategory, builder2.mPeople, builder2.mExtras, builder2.mColor, builder2.mVisibility, builder2.mPublicVersion, builder2.mGroupKey, builder2.mGroupSummary, builder2.mSortKey, builder2.mRemoteInputHistory, builder2.mContentView, builder2.mBigContentView, builder2.mHeadsUpContentView, builder.mGroupAlertBehavior);
    ...
    static class NotificationCompatApi26Impl extends NotificationCompatApi24Impl {
        ...
        public Notification build(Builder builder, BuilderExtender builderExtender) {
            ...
            android.support.v4.app.NotificationCompatApi26.Builder builder4 = new android.support.v4.app.NotificationCompatApi26.Builder(builder2.mContext, builder2.mNotification, builder2.mContentTitle, builder2.mContentText, builder2.mContentInfo, builder2.mTickerView, builder2.mNumber, builder2.mContentIntent, builder2.mFullScreenIntent, builder2.mLargeIcon, builder2.mProgressMax, builder2.mProgress, builder2.mProgressIndeterminate, builder2.mShowWhen, builder2.mUseChronometer, builder2.mPriority, builder2.mSubText, builder2.mLocalOnly, builder2.mCategory, builder2.mPeople, builder2.mExtras, builder2.mColor, builder2.mVisibility, builder2.mPublicVersion, builder2.mGroupKey, builder2.mGroupSummary, builder2.mSortKey, builder2.mRemoteInputHistory, builder2.mContentView, builder2.mBigContentView, builder2.mHeadsUpContentView, builder2.mChannelId, builder2.mBadgeIcon, builder2.mShortcutId, builder2.mTimeout, builder2.mColorized, builder2.mColorizedSet, builder.mGroupAlertBehavior);
