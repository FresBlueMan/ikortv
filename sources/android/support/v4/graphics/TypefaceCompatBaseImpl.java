...
class TypefaceCompatBaseImpl implements TypefaceCompatImpl {
    ...
    class C09301 implements StyleExtractor<FontInfo> {
        C09301() {
        }
    ...
    class C09312 implements StyleExtractor<FontFileResourceEntry> {
        C09312() {
        }
    ...
    protected FontInfo findBestInfo(FontInfo[] fontInfoArr, int i) {
        return (FontInfo) findBestFont(fontInfoArr, i, new C09301());
    }
...
*/
    ...
    private FontFileResourceEntry findBestEntry(FontFamilyFilesResourceEntry fontFamilyFilesResourceEntry, int i) {
        return (FontFileResourceEntry) findBestFont(fontFamilyFilesResourceEntry.getEntries(), i, new C09312());
    }
