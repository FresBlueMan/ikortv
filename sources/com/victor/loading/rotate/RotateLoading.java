...
public class RotateLoading extends View {
    ...
    /* renamed from: com.victor.loading.rotate.RotateLoading$1 */
    class C07981 implements AnimatorListener {
    ...
    private void initView(Context context, AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            attributeSet = context.obtainStyledAttributes(attributeSet, C0792R.styleable.RotateLoading);
            this.color = attributeSet.getColor(C0792R.styleable.RotateLoading_loading_color, -1);
            this.width = attributeSet.getDimensionPixelSize(C0792R.styleable.RotateLoading_loading_width, dpToPx(context, 6.0f));
            this.shadowPosition = attributeSet.getInt(C0792R.styleable.RotateLoading_shadow_position, 2);
            this.speedOfDegree = attributeSet.getInt(C0792R.styleable.RotateLoading_loading_speed, 10);
    ...
    protected void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        this.shadowRectF = new RectF((float) ((this.width * 2) + this.shadowPosition), (float) ((this.width * 2) + this.shadowPosition), (float) ((i - (this.width * 2)) + this.shadowPosition), (float) ((i2 - (this.width * 2)) + this.shadowPosition));
    }
    ...
    private void stopAnimator() {
        ...
        AnimatorSet animatorSet = new AnimatorSet();
        animatorSet.playTogether(new Animator[]{ofFloat, ofFloat2});
        animatorSet.addListener(new C07981());
        animatorSet.start();
    }
