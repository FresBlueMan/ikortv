...
public class CradleBall extends View {
    ...
    private void initView(AttributeSet attributeSet) {
        if (attributeSet != null) {
            attributeSet = getContext().obtainStyledAttributes(attributeSet, C0792R.styleable.CradleBall);
            this.loadingColor = attributeSet.getColor(C0792R.styleable.CradleBall_cradle_ball_color, -1);
