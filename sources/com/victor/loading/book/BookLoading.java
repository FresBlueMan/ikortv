...
public class BookLoading extends FrameLayout {
    ...
    private void initView(Context context) {
        LayoutInflater.from(context).inflate(C0792R.layout.book_loading, this, true);
    ...
    private void addPage() {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            pageView.setTag(C0792R.string.app_name, Integer.valueOf(i));
    ...
    private void playAnim() {
        ...
        for (int i = 4; i >= 0; i--) {
            setAnim((View) this.pageViews.get(i), ((long) (((4 - i) * 200) / 2)) + 3000);
        }
    }
    ...
    private void setAnim(final View view, long j) {
        ...
        ofFloat.addListener(new AnimatorListener() {
            ...
            public void onAnimationStart(Animator animator) {
                if (((Integer) view.getTag(C0792R.string.app_name)).intValue() == 4) {
                    view.bringToFront();
                }
            }
        });
