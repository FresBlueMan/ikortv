...
public class PageView extends View {
    ...
    private void initView() {
        this.padding = getResources().getDimension(C0792R.dimen.book_padding);
        this.border = getResources().getDimensionPixelOffset(C0792R.dimen.book_border);
        this.paint = new Paint();
        this.paint.setAntiAlias(true);
        this.paint.setStrokeWidth(getResources().getDimension(C0792R.dimen.page_border));
        this.path = new Path();
    }
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        this.paint.setColor(getResources().getColor(C0792R.color.book_loading_book));
        ...
        this.paint.setColor(getResources().getColor(C0792R.color.book_loading_page));
