...
final class DisplayBitmapTask implements Runnable {
    ...
    public void run() {
        if (this.imageAware.isCollected()) {
            ...
            C0778L.m1428d(LOG_DISPLAY_IMAGE_IN_IMAGEAWARE, this.loadedFrom, this.memoryCacheKey);
    ...
    private boolean isViewWasReused() {
        return this.memoryCacheKey.equals(this.engine.getLoadingUriForView(this.imageAware)) ^ 1;
    }
}
