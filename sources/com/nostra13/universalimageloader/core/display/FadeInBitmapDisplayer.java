...
public class FadeInBitmapDisplayer implements BitmapDisplayer {
    ...
    public void display(Bitmap bitmap, ImageAware imageAware, LoadedFrom loadedFrom) {
        ...
        if ((this.animateFromNetwork != null && loadedFrom == LoadedFrom.NETWORK) || ((this.animateFromDisk != null && loadedFrom == LoadedFrom.DISC_CACHE) || (this.animateFromMemory != null && loadedFrom == LoadedFrom.MEMORY_CACHE))) {
