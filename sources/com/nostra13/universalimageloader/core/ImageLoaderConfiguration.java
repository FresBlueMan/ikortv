...
public final class ImageLoaderConfiguration {
    ...
    public static class Builder {
        ...
        public Builder taskExecutor(Executor executor) {
            if (!(this.threadPoolSize == 3 && this.threadPriority == 3 && this.tasksProcessingType == DEFAULT_TASK_PROCESSING_TYPE)) {
                C0778L.m1433w(WARNING_OVERLAP_EXECUTOR, new Object[0]);
            }
        ...
        public Builder memoryCacheSize(int i) {
            if (i > 0) {
                if (this.memoryCache != null) {
                    C0778L.m1433w(WARNING_OVERLAP_MEMORY_CACHE, new Object[0]);
                }
        ...
        public Builder memoryCacheSizePercentage(int i) {
            ...
            this.memoryCacheSize = (int) (((float) Runtime.getRuntime().maxMemory()) * (((float) i) / 1120403456));
            return this;
        }
        ...
        public Builder diskCacheSize(int i) {
            if (i > 0) {
                if (this.diskCache != null) {
                    C0778L.m1433w(WARNING_OVERLAP_DISK_CACHE_PARAMS, new Object[0]);
                }
        ...
        public Builder diskCacheFileNameGenerator(FileNameGenerator fileNameGenerator) {
            if (this.diskCache != null) {
                C0778L.m1433w(WARNING_OVERLAP_DISK_CACHE_NAME_GENERATOR, new Object[0]);
            }
    ...
    private static class SlowNetworkImageDownloader implements ImageDownloader {
        ...
        public InputStream getStream(String str, Object obj) {
            obj = this.wrappedDownloader.getStream(str, obj);
            switch (Scheme.ofUri(str)) {
                case HTTP:
                case HTTPS:
                    return new FlushedInputStream(obj);
                default:
                    return obj;
            }
        }
    ...
    private ImageLoaderConfiguration(Builder builder) {
        ...
        C0778L.writeDebugLogs(builder.writeLogs);
    }
