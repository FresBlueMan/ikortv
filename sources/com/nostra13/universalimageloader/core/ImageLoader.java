...
public class ImageLoader {
    ...
    public synchronized void init(ImageLoaderConfiguration imageLoaderConfiguration) {
        if (imageLoaderConfiguration == null) {
            ...
            C0778L.m1428d(LOG_INIT_CONFIG, new Object[0]);
            this.engine = new ImageLoaderEngine(imageLoaderConfiguration);
            this.configuration = imageLoaderConfiguration;
        } else {
            C0778L.m1433w(WARNING_RE_INIT_CONFIG, new Object[0]);
        }
    }
    ...
    public void displayImage(String str, ImageAware imageAware, DisplayImageOptions displayImageOptions, ImageSize imageSize, ImageLoadingListener imageLoadingListener, ImageLoadingProgressListener imageLoadingProgressListener) {
        ...
        if (imageAware != null) {
            ...
            if (TextUtils.isEmpty(str) != null) {
                ...
                if (displayImageOptions.shouldShowImageForEmptyUri() != null) {
            ...
            imageLoadingListener2.onLoadingStarted(str, imageAware.getWrappedView());
            imageSize = this.configuration.memoryCache.get(generateKey);
            if (imageSize == null || imageSize.isRecycled() != null) {
                if (displayImageOptions.shouldShowImageOnLoading() != null) {
                    imageAware.setImageDrawable(displayImageOptions.getImageOnLoading(this.configuration.resources));
                } else if (displayImageOptions.isResetViewBeforeLoading() != null) {
                    imageAware.setImageDrawable(null);
                }
                ...
                if (displayImageOptions.isSyncLoading() != null) {
                    loadAndDisplayImageTask.run();
                } else {
                    this.engine.submit(loadAndDisplayImageTask);
                }
            } else {
                C0778L.m1428d(LOG_LOAD_IMAGE_FROM_MEMORY_CACHE, generateKey);
                if (displayImageOptions.shouldPostProcess() != null) {
                    ProcessAndDisplayImageTask processAndDisplayImageTask = new ProcessAndDisplayImageTask(this.engine, imageSize, new ImageLoadingInfo(str, imageAware, imageSize2, generateKey, displayImageOptions, imageLoadingListener2, imageLoadingProgressListener, this.engine.getLockForUri(str)), defineHandler(displayImageOptions));
                    if (displayImageOptions.isSyncLoading() != null) {
                    ...
                    displayImageOptions.getDisplayer().display(imageSize, imageAware, LoadedFrom.MEMORY_CACHE);
                    imageLoadingListener2.onLoadingComplete(str, imageAware.getWrappedView(), imageSize);
                }
            }
            return;
        }
    ...
    public void loadImage(String str, ImageSize imageSize, DisplayImageOptions displayImageOptions, ImageLoadingListener imageLoadingListener, ImageLoadingProgressListener imageLoadingProgressListener) {
        ...
        String str2 = str;
        displayImage(str2, new NonViewAware(str, imageSize, ViewScaleType.CROP), displayImageOptions, imageLoadingListener, imageLoadingProgressListener);
    }
    ...
    public Bitmap loadImageSync(String str, ImageSize imageSize, DisplayImageOptions displayImageOptions) {
        ...
        displayImageOptions = new Builder().cloneFrom(displayImageOptions).syncLoading(true).build();
        Object syncImageLoadingListener = new SyncImageLoadingListener();
        loadImage(str, imageSize, displayImageOptions, syncImageLoadingListener);
    ...
    public void destroy() {
        if (this.configuration != null) {
            C0778L.m1428d(LOG_DESTROY, new Object[0]);
        }
        stop();
