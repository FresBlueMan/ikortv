    ...
    public String readLine() {
        synchronized (this.in) {
            if (this.buf != null) {
                ...
                ByteArrayOutputStream c07661 = new ByteArrayOutputStream((this.end - this.pos) + 80) {
                ...
                loop1:
                while (true) {
                    c07661.write(this.buf, this.pos, this.end - this.pos);
                    this.end = -1;
                    fillBuf();
                    i = this.pos;
                    while (i != this.end) {
                ...
                if (i != this.pos) {
                    c07661.write(this.buf, this.pos, i - this.pos);
                }
                this.pos = i + 1;
                String byteArrayOutputStream = c07661.toString();
